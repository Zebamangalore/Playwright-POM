...
def complete_todo(page: Page, text: str) -> None:
...
def assert_count(page: Page, expected: str) -> None:
...
def test_trace_viewer(page: Page) -> None:
    ...
    assert_count(page, "0 item left!")
    print("✅ Lifecycle complete!")

# Tracing on — saves trace.zip to test-results/
#pytest tests/test_trace_viewer.py -v --tracing on

# Open the trace after the run
#playwright show-trace test-results/tests-test-trace-viewer-py-test-trace-viewer-chromium/trace.zip